...
class InformasiFragment : Fragment() {
    ...
    private fun buatDaftarInformasi(): List<ModelInformasi> = listOf(
        ...
        ModelInformasi(
            ...
            seksiBagian = listOf(
                SeksiBagian(
                    ...
                    isi = "• Permukaan daun berwarna hijau merata\n" +
                ...
                SeksiBagian(
                    ...
                    isi = "• Siram secara teratur di pagi hari\n" +
        ...
        ModelInformasi(
            ...
            seksiBagian = listOf(
                SeksiBagian(
                    judul = "Gejala",
                    isi = "• Muncul serbuk putih seperti tepung di permukaan daun\n" +
                ...
                SeksiBagian(
                    ...
                    isi = "• Semprot fungisida berbahan Sulfur atau Tembaga\n" +
                ...
                SeksiBagian(
                    judul = "Pencegahan",
                    isi = "• Pilih varietas tahan penyakit\n" +
        ...
        ModelInformasi(
            ...
            seksiBagian = listOf(
                SeksiBagian(
                    judul = "Gejala",
                    isi = "• Muncul bercak coklat kekuningan pada daun\n" +
                ...
                SeksiBagian(
                    judul = "Cara Penanganan & Mitigasi",
                    isi = "• Semprot fungisida berbahan Mankozeb atau Klorotalonil\n" +
                ...
                SeksiBagian(
                    judul = "Pencegahan",
                    isi = "• Gunakan benih bersertifikat bebas penyakit\n" +
        ...
        ModelInformasi(
            ...
            seksiBagian = listOf(
                SeksiBagian(
                    judul = "Gejala",
                    isi = "• Daun dan pucuk layu mendadak di siang hari\n" +
                ...
                SeksiBagian(
                    judul = "Cara Penanganan & Mitigasi",
                    isi = "• Cabut dan bakar tanaman yang terinfeksi segera\n" +
                ...
                SeksiBagian(
                    judul = "Pencegahan",
                    isi = "• Gunakan benih yang sudah diperlakukan fungisida\n" +
